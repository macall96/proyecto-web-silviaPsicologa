  ...
  menuItems = [
    { label: 'Inicio', icon: 'pi pi-home', routerLink: '/' },
    {
      ...
      items: [
        ...
        { label: 'Valores', routerLink: '/vision/valores', icon: 'pi pi-angle-right'}
      ]
    },
    {
      label: 'Sobre Mí',
      ...
      items: [
        ...
        { label: 'Formación y experiencia', routerLink: '/sobre-mi/formacionExp',icon: 'pi pi-angle-right'}
      ]
    },
    { label: 'Cómo puedo ayudarte',
      ...
      items: [
        { label: 'Cómo trabajo', routerLink: 'ayuda/gestionEmocional', icon: 'pi pi-angle-right'},
        { label: 'Sintomatología asociada', routerLink: 'ayuda/sintomatologia',icon: 'pi pi-angle-right' }
      ] 
    },
